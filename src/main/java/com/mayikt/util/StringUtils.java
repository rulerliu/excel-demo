...
public class StringUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println(StringUtils.toNumSectionAll(str1, 11, "0"));
		
		System.out.println(StringUtils.toDouble(null, 13.33));
		System.out.println(StringUtils.toDouble("122.22", 13.33));
	}
